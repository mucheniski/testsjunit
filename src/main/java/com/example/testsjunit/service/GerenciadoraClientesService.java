...
import com.example.testsjunit.exception.IdadeNaoPermitidaException;

import java.util.List;

public class GerenciadoraClientesService {

    private List<Cliente> clientesDoBanco;

    public GerenciadoraClientesService(List<Cliente> clientesDoBanco) {
